...
class Config:
    ...
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/Telexe_Bot")
    ...
    APP_DESCRIPTION = os.environ.get(
        "APP_DESCRIPTION",
        "created using https://telegram.dog/Telexe_Bot"
    )
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "<b>- تم الاستخـراج بواسطـة ☕️  @a_t_9</b>")
